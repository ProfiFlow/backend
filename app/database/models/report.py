from sqlalchemy import Column, Integer, String, Date, Float, JSON, ForeignKey, ForeignKeyConstraint, Index
...
class SprintReportDB(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['user_id', 'tracker_id'], ['user_tracker_roles.user_id', 'user_tracker_roles.tracker_id']),
