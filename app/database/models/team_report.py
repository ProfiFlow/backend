...
class TeamSprintReportDB(Base):
    ...
    employee_stats = Column(JSON, nullable=False)  # Список EmployeeSprintStats в виде JSON
    __table_args__ = (UniqueConstraint('tracker_id', 'sprint_id', name='_tracker_sprint_uc'),)
