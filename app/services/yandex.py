...
class YandexService:
    ...
    async def _make_yandex_tracker_request(self, method: str, url: str, access_token: str, org_id: str, data: dict = None):
    ...
    async def _get_user_info(self, token: str) -> YandexIdInfo:
        ...
        try:
            return YandexIdInfo(**await self._make_yandex_request(
